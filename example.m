...
switch n
    case 1
        ...
        lb = [-2 -pi];
        ub = [6 8-pi];
        [r,bb] = eigopt_multi_mesh('fdist_uncont',lb,ub,pars,opt);
    ...
    case 2
        ...
        lb = [-2 -pi];
        ub = [6 8-pi];
        [r,bb] = eigopt_multi_mesh('fdist_defective',lb,ub,pars,opt);
        figure; plot_results(r);
        figure; hist([bb.iternum],15)
    ...
    case 3
        ...
        lb = [-2 -pi];
        ub = [6 8-pi];
        [r,bb] = eigopt_multi_mesh('fdist_triple',lb,ub,pars,opt);
        figure; plot_results(r);
        figure; hist([bb.iternum],15)
